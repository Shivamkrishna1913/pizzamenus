    ...
    <main className="menu">
      ...
      <>
        ...
        {numPizzas > 0 ? (
          ...
          <p>
            We're still working on our menu.<strong>Please!!</strong> Come back
            later
          </p>
        )}
      </>
...
function Order(props) {
  return (
    <div className="order">
      <p>
        We're open untill untill <strong>{props.closeHour}</strong>:00. Come
        visit us <strong>or</strong> order online.
      </p>
